...
public class Registration {
    ...
    public static Observable<PushSecureClient> register(@NonNull Observable<String> getGcmToken,
        ...
        return Observable.zip(getGcmToken,
                              getOrCreateAuthToken(dataProvider, callback).doOnNext(client::setAuthenticationToken),
     ...
     */
    private static Observable<String> getOrCreateAuthToken(DataProvider dataProvider, PushServiceRegistrationCredentialsProvider callback) {
        if (dataProvider.getPushSecureAuthToken() != null)
